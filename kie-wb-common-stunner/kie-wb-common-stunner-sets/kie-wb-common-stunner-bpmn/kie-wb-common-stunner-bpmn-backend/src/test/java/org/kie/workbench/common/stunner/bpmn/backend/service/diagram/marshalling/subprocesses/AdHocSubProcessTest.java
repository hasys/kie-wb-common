...
public class AdHocSubProcessTest extends SubProcess<AdHocSubprocess> {
    ...
    private static final String IGNORE_MESSAGE = "There is a bug in old marshaller. Once, the bug is fixed, the " +
    ...
    public void testMarshallSubProcessLevelEmptyPropertiesSubProcess() {
        assumeFalse(IGNORE_MESSAGE, isCurrentMarshallerIsOld());
